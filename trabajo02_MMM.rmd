...
* Entre el numero de minutos jugados y los puntos la relacion es lineal. 
...
Mostramos graficamnete los datos obtenidos.
...
El modelo es muy bueno, el coeficiente R^2 ajustado es 0.5025, bastante alejado del optimo. Sin embargo el uso de la variables de los puntos parece adecuada de acuerdo al p-valor de la misma.
...
****
# Exportaci?n del código en R y de los datos producidos.
****
...
https://github.com/maxmucmor/clubsdata_cleaning/blob/main/trabajo02_MMM.rmd
...
https://github.com/maxmucmor/clubsdata_cleaning/blob/main/datos.csv
